...
namespace DS.ScriptableObjects
{
    public class DSDialogueContainerSO : ScriptableObject
    {
        ...
        public List<string> GetDialogueGroupNames()
        {
            ...
            foreach (DSDialogueGroupSO dialogueGroupSO in DialogueGroups.Keys)
            {
                dialogueGroupNames.Add(dialogueGroupSO.GroupName);
            }
        ...
        public List<string> GetUngroupedDialogueNames(bool startingDialoguesOnly)
        {
            ...
            foreach (DSDialogueSO dSDialogueSO in UngroupedDialogues)
            {
                if (startingDialoguesOnly && !dSDialogueSO.IsStartingDialogue)
                {
                    continue;
                }
                ungroupedDialogueNames.Add(dSDialogueSO.DialogueName);
            }
